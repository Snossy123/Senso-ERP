										...
										<div class="p-4 wd-100p">
											<div class="main-signin-header">
												...
												<div class="mx-auto text-center mt-4 mg-b-20">
													...
													<p class="tx-13 text-muted">{{ __('auth_pages.lockscreen.enter_password') }}</p>
												</div>
												<form action="#">
													<div class="form-group">
														<input class="form-control" placeholder="{{ __('auth_pages.lockscreen.password_placeholder') }}" type="password" value="">
													</div>
													<button class="btn btn-main-primary btn-block">{{ __('auth_pages.lockscreen.unlock') }}</button>
												</form>
											</div>
										</div>
									</div>
