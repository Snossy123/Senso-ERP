<header class="py-3 bg-white border-bottom shadow-sm">
    <nav class="navbar navbar-expand-lg navbar-light container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavSolid">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNavSolid">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                @auth('customer')
                    <li class="nav-item mx-2 dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-2">
                            ...
                            <li><a class="dropdown-item p-2 rounded text-danger" href="#" onclick="event.preventDefault(); document.getElementById('logout-customer-solid').submit();">Sign Out</a></li>
                        </ul>
                        <form id="logout-customer-solid" action="{{ route('store.logout') }}" method="POST" class="d-none">@csrf</form>
                    </li>
                @else
                ...
                <li class="nav-item ms-3">
                    <a href="{{ route('store.cart.index') }}" class="btn btn-outline-primary position-relative">
